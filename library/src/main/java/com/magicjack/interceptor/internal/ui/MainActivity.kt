...
import com.magicjack.interceptor.internal.ui.error.ErrorActivity
import com.magicjack.interceptor.internal.ui.error.ErrorAdapter
import com.magicjack.interceptor.internal.ui.transaction.TransactionActivity
import com.magicjack.interceptor.internal.ui.transaction.TransactionAdapter
import com.google.android.material.tabs.TabLayout

internal class MainActivity :
    BaseInterceptorActivity(),
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewPager.addOnPageChangeListener(object : TabLayout.TabLayoutOnPageChangeListener(tabLayout) {
            override fun onPageSelected(position: Int) {
                ...
                if (position == 0) {
                    Interceptor.dismissTransactionsNotification(this@MainActivity)
                } else {
                    Interceptor.dismissErrorsNotification(this@MainActivity)
                }
            }
        })
    ...
    private fun consumeIntent(intent: Intent) {
        ...
        val screenToShow = intent.getIntExtra(EXTRA_SCREEN, Interceptor.SCREEN_HTTP)
        if (screenToShow == Interceptor.SCREEN_HTTP) {
