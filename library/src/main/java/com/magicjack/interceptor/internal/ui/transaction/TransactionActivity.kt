...
import com.magicjack.interceptor.internal.support.FormatUtils.getShareCurlCommand
import com.magicjack.interceptor.internal.support.FormatUtils.getShareText
import com.magicjack.interceptor.internal.ui.BaseInterceptorActivity
import com.google.android.material.tabs.TabLayout

internal class TransactionActivity : BaseInterceptorActivity() {
    ...
    override fun onCreateOptionsMenu(menu: Menu): Boolean {
        menuInflater.inflate(R.menu.interceptor_transaction, menu)
    ...
    private fun share(transactionDetailsText: String) {
        startActivity(
            ShareCompat.IntentBuilder.from(this)
                .setType(MIME_TYPE)
                .setChooserTitle(getString(R.string.interceptor_share_transaction_title))
                .setSubject(getString(R.string.interceptor_share_transaction_subject))
