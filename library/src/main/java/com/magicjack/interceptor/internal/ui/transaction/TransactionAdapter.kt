...
internal class TransactionAdapter internal constructor(
    ...
    private val colorDefault: Int = ContextCompat.getColor(context, R.color.interceptor_status_default)
    private val colorRequested: Int = ContextCompat.getColor(context, R.color.interceptor_status_requested)
    private val colorError: Int = ContextCompat.getColor(context, R.color.interceptor_status_error)
    private val color500: Int = ContextCompat.getColor(context, R.color.interceptor_status_500)
    private val color400: Int = ContextCompat.getColor(context, R.color.interceptor_status_400)
    private val color300: Int = ContextCompat.getColor(context, R.color.interceptor_status_300)
