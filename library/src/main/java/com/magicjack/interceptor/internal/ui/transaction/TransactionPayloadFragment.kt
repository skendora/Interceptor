...
internal class TransactionPayloadFragment :
    ...
    override fun onCreateView(
        ...
        inflater.inflate(R.layout.interceptor_fragment_transaction_payload, container, false).apply {
    ...
    override fun onAttach(context: Context) {
        ...
        backgroundSpanColor = ContextCompat.getColor(context, R.color.interceptor_background_span_color)
        foregroundSpanColor = ContextCompat.getColor(context, R.color.interceptor_foreground_span_color)
    }
    ...
    private fun viewBodyExternally() {
        viewModel.transaction.value?.let {
            ...
            if (intent.resolveActivity(requireActivity().packageManager) != null) {
                ...
                Toast.makeText(
                    requireContext(), R.string.interceptor_save_failed_to_open_document,
                    Toast.LENGTH_SHORT
                ).show()
            }
        }
    ...
    class PayloadLoaderTask(private val fragment: TransactionPayloadFragment) :
        ...
        override fun doInBackground(vararg params: Pair<Int, HttpTransaction>): List<TransactionPayloadItem> {
            ...
            if (type == TYPE_RESPONSE && responseBitmap != null) {
                ...
                fragment.context?.getString(R.string.interceptor_body_omitted)?.let {
    ...
    class FileSaverTask(val fragment: TransactionPayloadFragment) :
        ...
        override fun onPostExecute(isSuccessful: Boolean) {
            ...
            val toastMessageId = if (isSuccessful) {
                R.string.interceptor_file_saved
            } else {
                R.string.interceptor_file_not_saved
            }
    ...
    companion object {
        ...
        const val DEFAULT_FILE_PREFIX = "interceptor-export-"
