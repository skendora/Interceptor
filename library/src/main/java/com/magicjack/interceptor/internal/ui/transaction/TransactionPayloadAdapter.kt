...
import com.magicjack.interceptor.internal.support.highlightWithDefinedColors
...
internal class TransactionBodyAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): TransactionPayloadViewHolder {
        ...
        return when (viewType) {
            TYPE_HEADERS -> {
                val view = inflater.inflate(R.layout.interceptor_transaction_item_headers, parent, false)
                TransactionPayloadViewHolder.HeaderViewHolder(view)
            }
            TYPE_BODY_LINE -> {
                val view = inflater.inflate(R.layout.interceptor_transaction_item_body_line, parent, false)
                TransactionPayloadViewHolder.BodyLineViewHolder(view)
            }
            else -> {
                val view = inflater.inflate(R.layout.interceptor_transaction_item_image, parent, false)
