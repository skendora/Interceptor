...
import com.magicjack.interceptor.internal.ui.error.ErrorListFragment
import com.magicjack.interceptor.internal.ui.transaction.TransactionListFragment
    ...
    override fun getPageTitle(position: Int): CharSequence? =
        context.get()?.getString(
            if (position == SCREEN_HTTP_INDEX) {
                R.string.interceptor_tab_network
            } else {
                R.string.interceptor_tab_errors
            }
        )
