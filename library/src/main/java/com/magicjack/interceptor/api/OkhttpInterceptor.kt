...
import com.magicjack.interceptor.api.Interceptor.LOG_TAG
import com.magicjack.interceptor.internal.data.entity.HttpTransaction
import com.magicjack.interceptor.internal.support.IOUtils
import com.magicjack.interceptor.internal.support.hasBody
 ...
 * @param collector A [InterceptorCollector] to customize data retention
 ...
 * with a `**` in the Interceptor UI.
 */
class OkhttpInterceptor @JvmOverloads constructor(
        private val context: Context,
        private val collector: InterceptorCollector = InterceptorCollector(context),
